...
public class Srvldatos extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String A=(String) sesion.getAttribute("usuarioSesion");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if(op.Login(usuario, contra)==1){
                sesion.setAttribute("usuario",contra);
                sesion.setAttribute("nivel","1");
                response.sendRedirect("IndAdmin.jsp");
            }
            else if(op.Login(usuario, contra)==2){
            ...
            out.println("<a href=\"consultar.jsp\">Volver</a>");
            out.println("</body>");
            out.println("</html>");
            }
